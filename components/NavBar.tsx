  ...
  return (
    <header className="bg-gradient-to-r from-violet-700 to-violet-500 text-white shadow relative z-40">
      <nav className="max-w-5xl mx-auto flex items-center justify-between px-4 py-3">
        <Link href="/" className="font-bold text-lg flex items-center gap-2 hover:scale-[1.02] transition-transform whitespace-nowrap">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="md:hidden p-1.5 rounded-lg hover:bg-white/10 active:scale-95 transition-all cursor-pointer"
      ...
      {/* Mobile Drawer Menu */}
      {isMenuOpen && (
        <div className="md:hidden border-t border-violet-600/30 bg-violet-800/95 px-4 py-3 space-y-2 animate-in slide-in-from-top duration-150">
          <Link
            href="/bookings"
